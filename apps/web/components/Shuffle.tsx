          ...
          wrappersRef.current.forEach(
            (w) => {
              ...
              for (
                ...
                kids[i].textContent =
                  scrambleCharset.charAt(
                    Math.floor(
                      Math.random() *
                        scrambleCharset.length
                    )
                  );
              }
            }
